...
func (bu *BookingUpdate) SetBookID(id int) *BookingUpdate {
	bu.mutation.SetBookID(id)
	return bu
}

// SetNillableBookID sets the book edge to Bookingtype by id if the given value is not nil.
func (bu *BookingUpdate) SetNillableBookID(id *int) *BookingUpdate {
	if id != nil {
		bu = bu.SetBookID(*id)
	}
	return bu
...
func (bu *BookingUpdate) SetBook(b *Bookingtype) *BookingUpdate {
...
func (bu *BookingUpdate) ClearBook() *BookingUpdate {
...
// SetBookID sets the book edge to Bookingtype by id.
func (buo *BookingUpdateOne) SetBookID(id int) *BookingUpdateOne {
	buo.mutation.SetBookID(id)
	return buo
}

// SetNillableBookID sets the book edge to Bookingtype by id if the given value is not nil.
func (buo *BookingUpdateOne) SetNillableBookID(id *int) *BookingUpdateOne {
	if id != nil {
...
// SetBook sets the book edge to Bookingtype.
func (buo *BookingUpdateOne) SetBook(b *Bookingtype) *BookingUpdateOne {
...
// ClearBook clears the book edge to Bookingtype.
func (buo *BookingUpdateOne) ClearBook() *BookingUpdateOne {
